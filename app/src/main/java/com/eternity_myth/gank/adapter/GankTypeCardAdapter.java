package com.eternity_myth.gank.adapter;
...
import com.eternity_myth.gank.Html5Activity;
...
public class GankTypeCardAdapter extends RecyclerView.Adapter<GankTypeCardAdapter.CardViewHolder> {
    ...
    private List<GankData> mDatas = new ArrayList<>();
    private static final int TYPE_PIC = 10000;
    private static final int TYPE_ITEM = 10001;

    public GankTypeCardAdapter(Context context, List<GankData> datas) {
    ...
    public void onBindViewHolder(CardViewHolder holder, int position) {
        GankData data = mDatas.get(position);
